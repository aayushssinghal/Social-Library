...
function submit(){
if(document.returnbook.accno.value==""){alert("enter proper values"); return false;}
var url="returnbook?accno="+document.returnbook.accno.value;
 //alert(url);
 if(xmlhttp) {
...
function handleEnter (event) {
    ...
    <body><div align="center">
        <h1>Return book</h1>
        <form name="returnbook" id="returnbook">
		<table>
<tr>
